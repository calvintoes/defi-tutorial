...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    // JS Web3 version of DaiToken contract
    ...
    // JS Web3 version of DappToken contract
    ...
    if (tokenFarmData) {
      ...
      let tokenFarmBalance = await tokenFarm.methods
        ...
        .call();
      this.setState({ dappTokenBalance: tokenFarmBalance.toString() });
      console.log({ tokenFarmBalance: tokenFarmBalance });
    } else {
  ...
  async loadWeb3() {
    if (window.ethereum) {
      ...
      window.alert(
        "Non-Ethereum browser detected. You should consider tring MetaMask"
      );
    }
  }
